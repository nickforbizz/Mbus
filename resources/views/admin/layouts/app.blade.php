		...
		<ul class="nav menu">
			...
			<li class="parent"><a data-toggle="collapse" href="#sub-item-bus">
				...
				<ul class="children collapse" id="sub-item-bus">
					...
					<li><a class="" href="{{ url('/bus/busRoute') }}">
						<span class="fa fa-arrow-right">&nbsp;</span>  Bus Route
					</a></li>
				</ul>
			</li>
			<!-- users -->
            <li class="parent "><a data-toggle="collapse" href="#sub-item-user">
				...
				<ul class="children collapse" id="sub-item-user">
					...
					<div class="line"></div>
					<li><a class="" href="{{ url('users/driver') }}">
						<span class="fa fa-arrow-right">&nbsp;</span> Driver
					</a></li>
					<li><a class="" href="{{ url('users/conductor') }}">
						<span class="fa fa-arrow-right">&nbsp;</span> Conductor
					</a></li>
					<li><a class="" href="{{ url('users/passanger') }}">
						<span class="fa fa-arrow-right">&nbsp;</span> Passanger
					</a></li>
					<li><a class="" href="{{ url('users/employee') }}">
			...
			<li><a href="{{ url('/trip') }}"><em class="fa fa-power-off">&nbsp;</em> Trips</a></li>
			<li><a href="{{ url('/ticket') }}"><em class="fa fa-power-off">&nbsp;</em> Tickets</a></li>

			<li class="parent "><a data-toggle="collapse" href="#sub-item-expences">
				<em class="fa fa-navicon">&nbsp;</em> Expences <span data-toggle="collapse" href="#sub-item-expences" class="icon pull-right"><em class="fa fa-plus"></em></span>
				</a>
				<ul class="children collapse" id="sub-item-expences">
					<li><a class="" href="{{ url('expences/salary') }}">
							<span class="fa fa-arrow-right">&nbsp;</span> Salary
						</a>
					</li>
					<li><a class="" href="{{ url('expences/user_damages') }}">
							<span class="fa fa-arrow-right">&nbsp;</span> User Damages
						</a>
					</li>
					<li><a class="" href="{{ url('expences/deductions') }}">
							<span class="fa fa-arrow-right">&nbsp;</span> Deductions
						</a>
					</li>
				</ul>
			</li>

			<!-- <li><a href="login.html"><em class="fa fa-power-off">&nbsp;</em> </a></li> -->
